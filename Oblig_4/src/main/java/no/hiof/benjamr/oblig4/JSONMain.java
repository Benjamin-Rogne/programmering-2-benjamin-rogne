...
import no.hiof.benjamr.oblig4.model.TVSeriesJSONRepository;
...
public class JSONMain {
    public static void main(String[] args){
        ...
        File file = new File("tv_series.json");
        TVSeriesJSONRepository repository = new TVSeriesJSONRepository(file);
